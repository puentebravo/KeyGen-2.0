...
function PassCard() {
  ...
  const generatePass = (pwLength) => {
    ...
    let pwSource = "1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz.!@#$%^&*.,?";
    let genPass = "";
    ...
    if (numLength >= 8 && numLength <= 128) {
      ...
      setPassword("You require more pylons! Please select a number between 8 and 128.")
    }
  };
